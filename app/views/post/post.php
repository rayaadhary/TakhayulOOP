				...
				<div class="row">
					<div class="col">
						<ul class="breadcrumbs_list d-flex flex-row align-items-center justify-content-start">
							<li><a href="<?= BASEURL;?>/index.html">home</a></li>
							<li><a href="<?= BASEURL;?>/courses.html">courses</a></li>
							<li><a href="<?= BASEURL;?>/courses.html">spanish</a></li>
							<li>vocabulary</li>
						</ul>
					</div>
				</div>
					...
					<div class="intro_container d-flex flex-column align-items-start justify-content-end">
						<div class="intro_content">
							...
							<div class="intro_meta">
								<div class="intro_image"><img src="<?= BASEURL; ?>/images/intro_user.jpg" alt=""></div>
								<div class="intro_instructors"><a href="<?= BASEURL;?>/instructors.html">Sarah Parker</a> and <span><a href="<?= BASEURL;?>/instructors.html">5 other instructors</a></span></div>
							</div>
						</div>
					</div>
				</div>
			...
			<div class="row row-lg-eq-height">
					...
					<div class="tab_panels">
								...
								<div class="row instructors_row">
									...
									<div class="col-lg-4 col-md-6">
										<div class="instructor d-flex flex-row align-items-center justify-content-start">
											<div class="instructor_image"><div><img src="<?= BASEURL; ?>/images/instructor_4.jpg" alt=""></div></div>
											<div class="instructor_content">
												<div class="instructor_name"><a href="<?= BASEURL;?>/instructors.html">Sarah Parker</a></div>
									...
									<div class="col-lg-4 col-md-6">
										<div class="instructor d-flex flex-row align-items-center justify-content-start">
											<div class="instructor_image"><div><img src="<?= BASEURL; ?>/images/instructor_5.jpg" alt=""></div></div>
											<div class="instructor_content">
												<div class="instructor_name"><a href="<?= BASEURL;?>/instructors.html">Sarah Parker</a></div>
												<div class="instructor_title">Teacher</div>
											</div>
									...
									<div class="col-lg-4 col-md-6">
										<div class="instructor d-flex flex-row align-items-center justify-content-start">
											<div class="instructor_image"><div><img src="<?= BASEURL; ?>/images/instructor_6.jpg" alt=""></div></div>
											<div class="instructor_content">
												<div class="instructor_name"><a href="<?= BASEURL;?>/instructors.html">Sarah Parker</a></div>
												<div class="instructor_title">Teacher</div>
											</div>
									...
									<div class="col-lg-4 col-md-6">
										<div class="instructor d-flex flex-row align-items-center justify-content-start">
											<div class="instructor_image"><div><img src="<?= BASEURL; ?>/images/instructor_7.jpg" alt=""></div></div>
											<div class="instructor_content">
												<div class="instructor_name"><a href="<?= BASEURL;?>/instructors.html">Sarah Parker</a></div>
												<div class="instructor_title">Teacher</div>
											</div>
									...
									<div class="col-lg-4 col-md-6">
										<div class="instructor d-flex flex-row align-items-center justify-content-start">
											<div class="instructor_image"><div><img src="<?= BASEURL; ?>/images/instructor_8.jpg" alt=""></div></div>
											<div class="instructor_content">
												<div class="instructor_name"><a href="<?= BASEURL;?>/instructors.html">Sarah Parker</a></div>
												<div class="instructor_title">Teacher</div>
											</div>
									...
									<div class="col-lg-4 col-md-6">
										<div class="instructor d-flex flex-row align-items-center justify-content-start">
											<div class="instructor_image"><div><img src="<?= BASEURL; ?>/images/instructor_9.jpg" alt=""></div></div>
											<div class="instructor_content">
												<div class="instructor_name"><a href="<?= BASEURL;?>/instructors.html">Sarah Parker</a></div>
												<div class="instructor_title">Teacher</div>
											</div>
												...
												<li>
													...
													<ul>
														<li class="d-flex flex-row align-items-center justify-content-start">
															<i class="fa fa-video-camera" aria-hidden="true"></i><span>Video: <a href="<?= BASEURL;?>/#">Greetings and Introductions</a></span>
															<div class="cur_time ml-auto"><i class="fa fa-clock-o" aria-hidden="true"></i><span>15 minutes</span></div>
														</li>
														<li class="d-flex flex-row align-items-center justify-content-start">
															<i class="fa fa-file" aria-hidden="true"></i><span>Reading: <a href="<?= BASEURL;?>/#">Word Types</a></span>
															<div class="cur_time ml-auto"><i class="fa fa-clock-o" aria-hidden="true"></i><span>15 minutes</span></div>
														</li>
														<li class="d-flex flex-row align-items-center justify-content-start">
															<i class="fa fa-volume-up" aria-hidden="true"></i><span>Audio: <a href="<?= BASEURL;?>/#">Listening Exercise</a></span>
															<div class="cur_time ml-auto"><i class="fa fa-clock-o" aria-hidden="true"></i><span>15 minutes</span></div>
														</li>
													</ul>
												</li>
								...
								<div class="review">
									<div class="review_title_container d-flex flex-row align-items-start justify-content-start">
										<div class="review_title d-flex flex-row align-items-center justify-content-center">
											<div class="review_author_image"><div><img src="<?= BASEURL; ?>/images/review_1.jpg" alt=""></div></div>
											<div class="review_author">
												<div class="review_author_name"><a href="<?= BASEURL;?>/#">Sarah Parker</a></div>
						...
						<div class="tab_panel members">
							...
							<div class="members_list d-flex flex-row flex-wrap align-items-start justify-content-start">
								...
								<!-- Member -->
								<div class="member">
									<div class="member_image"><img src="<?= BASEURL; ?>/images/member_1.jpg" alt=""></div>
									<div class="member_title"><a href="<?= BASEURL;?>/#">Sarah Parker</a></div>
								</div>

								<!-- Member -->
								<div class="member">
									<div class="member_image"><img src="<?= BASEURL; ?>/images/member_0.jpg" alt=""></div>
									<div class="member_title"><a href="<?= BASEURL;?>/#">Sarah Parker</a></div>
								</div>
								...
								<!-- Member -->
								<div class="member">
									<div class="member_image"><img src="<?= BASEURL; ?>/images/member_2.jpg" alt=""></div>
									<div class="member_title"><a href="<?= BASEURL;?>/#">Sarah Parker</a></div>
								</div>

								<!-- Member -->
								<div class="member">
									<div class="member_image"><img src="<?= BASEURL; ?>/images/member_3.jpg" alt=""></div>
									<div class="member_title"><a href="<?= BASEURL;?>/#">Sarah Parker</a></div>
								</div>

								<!-- Member -->
								<div class="member">
									<div class="member_image"><img src="<?= BASEURL; ?>/images/member_4.jpg" alt=""></div>
									<div class="member_title"><a href="<?= BASEURL;?>/#">Sarah Parker</a></div>
								</div>
								...
								<!-- Member -->
								<div class="member">
									<div class="member_image"><img src="<?= BASEURL; ?>/images/member_5.jpg" alt=""></div>
									<div class="member_title"><a href="<?= BASEURL;?>/#">Sarah Parker</a></div>
								</div>

								<!-- Member -->
								<div class="member">
									<div class="member_image"><img src="<?= BASEURL; ?>/images/member_6.jpg" alt=""></div>
									<div class="member_title"><a href="<?= BASEURL;?>/#">Sarah Parker</a></div>
								</div>
								...
								<!-- Member -->
								<div class="member">
									<div class="member_image"><img src="<?= BASEURL; ?>/images/member_7.jpg" alt=""></div>
									<div class="member_title"><a href="<?= BASEURL;?>/#">Sarah Parker</a></div>
								</div>

								<!-- Member -->
								<div class="member">
									<div class="member_image"><img src="<?= BASEURL; ?>/images/member_8.jpg" alt=""></div>
									<div class="member_title"><a href="<?= BASEURL;?>/#">Sarah Parker</a></div>
								</div>
								...
								<!-- Member -->
								<div class="member">
									<div class="member_image"><img src="<?= BASEURL; ?>/images/member_9.jpg" alt=""></div>
									<div class="member_title"><a href="<?= BASEURL;?>/#">Sarah Parker</a></div>
								</div>
				...
				<div class="col-lg-3">
					<div class="sidebar">
						...
						<div class="sidebar_top"><a href="<?= BASEURL;?>/#">buy course</a></div>
						<div class="sidebar_content">
							...
							<div class="sidebar_section cert">
								...
								<div class="cert_image"><img src="<?= BASEURL; ?>/images/cert.jpg" alt=""></div>
							</div>
				...
				<div class="row">
					...
					<div class="col-lg-3 footer_col">
						<div class="newsletter_container d-flex flex-column align-items-start justify-content-end">
							<div class="footer_logo mb-auto"><a href="<?= BASEURL;?>/#">Lingua</a></div>
					...
					<div class="col-lg-2 offset-lg-3 footer_col">
						<div>
							...
							<ul class="footer_list">
								<li><a href="<?= BASEURL;?>/#">Courses</a></li>
								<li><a href="<?= BASEURL;?>/#">Team</a></li>
								<li><a href="<?= BASEURL;?>/#">Brand Guidelines</a></li>
								<li><a href="<?= BASEURL;?>/#">Jobs</a></li>
								<li><a href="<?= BASEURL;?>/#">Advertise with us</a></li>
								<li><a href="<?= BASEURL;?>/#">Press</a></li>
					...
					<div class="col-lg-2 footer_col">
						...
						<ul class="footer_list">
							<li><a href="<?= BASEURL;?>/#">Discussions</a></li>
							<li><a href="<?= BASEURL;?>/#">Troubleshooting</a></li>
							<li><a href="<?= BASEURL;?>/#">Duolingo FAQs</a></li>
							<li><a href="<?= BASEURL;?>/#">Schools FAQs</a></li>
							<li><a href="<?= BASEURL;?>/#">Duolingo English Test FAQs</a></li>
							<li><a href="<?= BASEURL;?>/#">Status</a></li>
						</ul>
					</div>
					...
					<div class="col-lg-2 footer_col clearfix">
						<div>
							...
							<ul class="footer_list">
								<li><a href="<?= BASEURL;?>/#">Community Guidelines</a></li>
								<li><a href="<?= BASEURL;?>/#">Terms</a></li>
								<li><a href="<?= BASEURL;?>/#">Brand Guidelines</a></li>
								<li><a href="<?= BASEURL;?>/#">Privacy</a></li>
							</ul>
						</div>
					</div>
...
Copyright &copy;<script>document.write(new Date().getFullYear());</script> All rights reserved | Made with <i class="fa fa-heart-o" aria-hidden="true"></i> by <a href="<?= BASEURL;?>/https://colorlib.com" target="_blank">Colorlib</a> &amp; distributed by <a href="<?= BASEURL;?>/https://themewagon.com" target="_blank">ThemeWagon</a>
